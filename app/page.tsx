...
export default function Home() {
  ...
  return (
    <>
      ...
      >
        <title>Home</title>
        <link rel="icon" href="https://github.com/quiteboring.png" />
        <Grid />
            ...
            <div className="grid grid-cols-1 gap-5 sm:grid-cols-[1fr_160px]">
              ...
              <div className="relative w-full rounded-lg border border-neutral-700 bg-neutral-900 p-5">
                <div className="flex items-start gap-4">
                  <Image
                    src="https://github.com/quiteboring.png"
                    alt="Profile Picture"
                  ...
                  <div>
                    <h1 className="text-2xl font-bold">Nathan</h1>
              ...
              <div className="relative rounded-lg border border-neutral-700 bg-neutral-900 p-5">
                ...
                <div className="flex flex-row gap-2 sm:flex-col">
                  <a
                    ...
                    className="flex items-center gap-2 rounded-md border border-neutral-700 bg-neutral-900 px-3 py-1.5 text-sm text-neutral-300 transition-colors hover:border-slate-500"
                  >
